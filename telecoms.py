...
BASE_DIR = APP_DIR / "data" / "telecoms"
...
def main():
    ...
    for pdir in participants:
        ...
        if not segments:
            log(f"[WARN] No T-task segments found for {participant}")
            continue
    ...
    master_path = OUTPUT_DIR / "telecoms_master_dataset.csv"
    summary_path = OUTPUT_DIR / "telecoms_task_summary.csv"
    ...
    if not master_df.empty:
        ...
        summary_bar(summary, "Task", "CompletionTimeMean_sec", "Telecoms Mean Completion Time", "summary_completion_time.png")
        summary_bar(summary, "Task", "SuccessRate", "Telecoms Success Rate", "summary_success_rate.png")
        summary_bar(summary, "Task", "CogLoadMean", "Telecoms Mean Cognitive Load", "summary_cognitive_load.png")
        summary_bar(summary, "Task", "CogLoadPeakMean", "Telecoms Mean Cognitive Peak", "summary_cognitive_peak.png")
        summary_bar(summary, "Task", "HR_DeltaMean", "Telecoms Mean HR Delta", "summary_hr_delta.png")
        summary_bar(summary, "Task", "HR_MeanMean", "Telecoms Mean HR", "summary_hr_mean.png")
        summary_bar(summary, "Task", "EDA_TonicMean", "Telecoms Mean EDA Tonic", "summary_eda_tonic.png")
        summary_bar(summary, "Task", "EDA_PeakRateMean", "Telecoms Mean EDA Peak Rate", "summary_eda_peakrate.png")
        summary_bar(summary, "Task", "ConfusedMean", "Telecoms Mean Confusion", "summary_confusion.png")
        summary_bar(summary, "Task", "EstimatedFixationEpisodesMean", "Telecoms Estimated Fixation Episodes", "summary_fixation_episodes.png")
        summary_bar(summary, "Task", "EstimatedFixationMeanDuration_ms_Mean", "Telecoms Mean Fixation Duration", "summary_fixation_duration.png")
        summary_bar(summary, "Task", "CompletionTimeStd_sec", "Telecoms Time Variability", "summary_time_std.png")
    else:
