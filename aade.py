...
def main():
    ...
    for pdir in participants:
        ...
        if not segments:
            log(f"[WARN] No A-task segments found for {participant}")
            continue
    ...
    master_path = OUTPUT_DIR / "aade_master_dataset.csv"
    summary_path = OUTPUT_DIR / "aade_task_summary.csv"
    ...
    if not master_df.empty:
        ...
        summary_bar(summary, "Task", "CompletionTimeMean_sec", "AADE Mean Completion Time", "summary_completion_time.png")
        summary_bar(summary, "Task", "SuccessRate", "AADE Success Rate", "summary_success_rate.png")
        summary_bar(summary, "Task", "CogLoadMean", "AADE Mean Cognitive Load", "summary_cognitive_load.png")
        summary_bar(summary, "Task", "CogLoadPeakMean", "AADE Mean Cognitive Peak", "summary_cognitive_peak.png")
        summary_bar(summary, "Task", "HR_DeltaMean", "AADE Mean HR Delta", "summary_hr_delta.png")
        summary_bar(summary, "Task", "HR_MeanMean", "AADE Mean HR", "summary_hr_mean.png")
        summary_bar(summary, "Task", "EDA_TonicMean", "AADE Mean EDA Tonic", "summary_eda_tonic.png")
        summary_bar(summary, "Task", "EDA_PeakRateMean", "AADE Mean EDA Peak Rate", "summary_eda_peakrate.png")
        summary_bar(summary, "Task", "ConfusedMean", "AADE Mean Confusion", "summary_confusion.png")
        summary_bar(summary, "Task", "EstimatedFixationEpisodesMean", "AADE Estimated Fixation Episodes", "summary_fixation_episodes.png")
        summary_bar(summary, "Task", "EstimatedFixationMeanDuration_ms_Mean", "AADE Mean Fixation Duration", "summary_fixation_duration.png")
    else:
