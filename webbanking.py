...
BASE_DIR = APP_DIR / "data" / "webbanking"
...
def main():
    ...
    for pdir in participants:
        ...
        if not segments:
            log(f"[WARN] No B-task segments found for {participant}")
            continue
    ...
    master_path = OUTPUT_DIR / "webbanking_master_dataset.csv"
    summary_path = OUTPUT_DIR / "webbanking_task_summary.csv"
    ...
    if not master_df.empty:
        ...
        summary_bar(summary, "Task", "CompletionTimeMean_sec", "Webbanking Mean Completion Time", "summary_completion_time.png")
        summary_bar(summary, "Task", "SuccessRate", "Webbanking Success Rate", "summary_success_rate.png")
        summary_bar(summary, "Task", "CogLoadMean", "Webbanking Mean Cognitive Load", "summary_cognitive_load.png")
        summary_bar(summary, "Task", "CogLoadPeakMean", "Webbanking Mean Cognitive Peak", "summary_cognitive_peak.png")
        summary_bar(summary, "Task", "HR_DeltaMean", "Webbanking Mean HR Delta", "summary_hr_delta.png")
        summary_bar(summary, "Task", "HR_MeanMean", "Webbanking Mean HR", "summary_hr_mean.png")
        summary_bar(summary, "Task", "EDA_TonicMean", "Webbanking Mean EDA Tonic", "summary_eda_tonic.png")
        summary_bar(summary, "Task", "EDA_PeakRateMean", "Webbanking Mean EDA Peak Rate", "summary_eda_peakrate.png")
        summary_bar(summary, "Task", "ConfusedMean", "Webbanking Mean Confusion", "summary_confusion.png")
        summary_bar(summary, "Task", "EstimatedFixationEpisodesMean", "Webbanking Estimated Fixation Episodes", "summary_fixation_episodes.png")
        summary_bar(summary, "Task", "EstimatedFixationMeanDuration_ms_Mean", "Webbanking Mean Fixation Duration", "summary_fixation_duration.png")
        summary_bar(summary, "Task", "CompletionTimeStd_sec", "Webbanking Time Variability", "summary_time_std.png")
    else:
