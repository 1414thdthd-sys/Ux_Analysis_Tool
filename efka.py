...
def main():
    ...
    for pdir in participants:
        ...
        if not segments:
            log(f"[WARN] No F-task segments found for {participant}")
            continue
    ...
    master_path = OUTPUT_DIR / "efka_master_dataset.csv"
    summary_path = OUTPUT_DIR / "efka_task_summary.csv"
    ...
    if not master_df.empty:
        ...
        summary_bar(summary, "Task", "CompletionTimeMean_sec", "EFKA Mean Completion Time", "summary_completion_time.png")
        summary_bar(summary, "Task", "SuccessRate", "EFKA Success Rate", "summary_success_rate.png")
        summary_bar(summary, "Task", "CogLoadMean", "EFKA Mean Cognitive Load", "summary_cognitive_load.png")
        summary_bar(summary, "Task", "CogLoadPeakMean", "EFKA Mean Cognitive Peak", "summary_cognitive_peak.png")
        summary_bar(summary, "Task", "HR_DeltaMean", "EFKA Mean HR Delta", "summary_hr_delta.png")
        summary_bar(summary, "Task", "HR_MeanMean", "EFKA Mean HR", "summary_hr_mean.png")
        summary_bar(summary, "Task", "EDA_TonicMean", "EFKA Mean EDA Tonic", "summary_eda_tonic.png")
        summary_bar(summary, "Task", "EDA_PeakRateMean", "EFKA Mean EDA Peak Rate", "summary_eda_peakrate.png")
        summary_bar(summary, "Task", "ConfusedMean", "EFKA Mean Confusion", "summary_confusion.png")
        summary_bar(summary, "Task", "EstimatedFixationEpisodesMean", "EFKA Estimated Fixation Episodes", "summary_fixation_episodes.png")
        summary_bar(summary, "Task", "EstimatedFixationMeanDuration_ms_Mean", "EFKA Mean Fixation Duration", "summary_fixation_duration.png")
        summary_bar(summary, "Task", "CompletionTimeStd_sec", "EFKA Time Variability", "summary_time_std.png")
    else:
